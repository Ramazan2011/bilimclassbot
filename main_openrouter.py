...
# --- CONFIGURATION ---
ADMIN_IDS = [5664187652]  # ADD ALL ADMIN IDs (User or Group) to this list
# ---------------------
...
async def ai_response(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_message in ["📋 Сабақ кестесі", "📋 Расписание", "Сабақ кестесі", "Расписание"]:
    ...
    elif user_message in ["📚 Үй тапсырмасы", "📚 Домашка", "Үй тапсырмасы", "Домашка"]:
